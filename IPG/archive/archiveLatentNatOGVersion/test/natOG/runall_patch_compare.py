...
parser.add_argument('--date', default='07_17_2021', type=str, help='experiment date')
...
parser.add_argument('--gamma4', default=1-1e-12, type=float, help='params for inexact_type 4')
parser.add_argument('--fallback', default=1000, type=int, help='number of times to dynamic adjust stepsize')
