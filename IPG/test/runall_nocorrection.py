...
from src.regularizer_nocorrection import NatOG
from src.solver_nocorrection import IpgSolver
...
# python runall_nocorrection.py --date 09_21_2021 --inexact_type yd --gamma_yd 0.1 --lam_shrink 0.1 --group_size 100 --overlap_ratio 0.3 --debug True --tol 1e-6
