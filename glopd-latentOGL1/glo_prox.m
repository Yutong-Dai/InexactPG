function [w,q,lambda_tot,z] = glo_prox(w0,tau,blocks,weights,lambda0,tol,max_iter)
...
%         fprintf("iter:  %d | fdiff: %e | rhs: %e\n", m, fdiff, sigma*(step*x_inactive+x_active))
